...
/**
 * POI EXCEL 图表-折线图--不同sheet
 * 图表与统计数据不在一个sheet时操作
 */
public class ApachePoiLineChartSheet4 {

    public static void main(String[] args) throws IOException {
        XSSFWorkbook wb = new XSSFWorkbook("/Users/hui.yang/Desktop/excel演示/poi/生成图表/曲线图不同sheet.xlsx");
        ...
        try {
           ...
           /*
            ...
            //我要生成excel图表的sheet
            XSSFSheet sheet2 = wb.getSheet("表格");
   ...
   /*         XDDFLineChartData.Series series2 = (XDDFLineChartData.Series) data.addSeries(countries, population);
           ...
           /* XDDFNumericalDataSource<Double> population3 = XDDFDataSourcesFactory.fromNumericCellRange(sheet, new CellRangeAddress(3, 3, 0, 6));
            ...
            // 将输出写入excel文件
            String filename = "/Users/hui.yang/Desktop/excel演示/poi/生成图表/演示生成曲线图不同sheet.xlsx";
